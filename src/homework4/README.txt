1. homework4.dto.DataContainer.java - DataContainer class
2. homework4.dto.NaturalOrderComparator.java - NaturalOrderComparator class which implements the Interface Comparator
3. homework4.rummers.DataContainerMain.java - tests
